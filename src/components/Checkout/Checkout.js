            ...
            <div className="messages">
              ...
              {submitted && (
                <div className="success">
                  <h4 className="bg-custom-green text-white text-center">Compra realizada con éxito. ID de orden: {orderId}</h4>
                </div>
              )}
              ...
              <form className="needs-validation" onSubmit={(e) => e.preventDefault()}>
                <div className="row g-3">
                  <div className="col-12">
                    ...
                    <input onChange={(e) => setNombre(e.target.value)} value={nombre} type="text" className="form-control input" id="name" placeholder="Nombres y apellidos" required />
                  </div>
                  <div className="col-12">
                    <label htmlFor="ciudad" className="form-label">Ciudad</label>
                    <input onChange={(e) => setCiudad(e.target.value)} value={ciudad} type="text" className="form-control input" id="ciudad" placeholder="Ciudad" required />
                  </div>
                  <div className="col-6">
                    <label htmlFor="calle" className="form-label">Calle</label>
                    <input onChange={(e) => setCalle(e.target.value)} value={calle} type="text" className="form-control input" id="calle" placeholder="Nombre de la calle" required />
                  </div>
                  <div className="col-6">
                    <label htmlFor="numero" className="form-label">Número</label>
                    <input onChange={(e) => setNumero(e.target.value)} value={numero} type="text" className="form-control input" id="numero" placeholder="Número de la casa" required />
                  </div>
                </div>
                <hr className="my-4" />
